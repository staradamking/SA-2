...
const months = [
  { name: "Батальон ЗВЕЗДА", dates: "22 сен – 21 окт 2025" },
  { name: "Батальон ЛУНА", dates: "22 окт – 20 ноя 2025" },
  { name: "Батальон НЕБО", dates: "21 ноя – 20 дек 2025" },
  { name: "Батальон СНЕГ", dates: "21 дек 2025 – 19 янв 2026" },
  { name: "Батальон ВОДА", dates: "20 янв – 18 фев 2026" },
  { name: "Батальон ВЕТЕР", dates: "19 фев – 20 мар 2026" },
  { name: "Батальон СОЛНЦЕ", dates: "21 мар – 19 апр 2026" },
  { name: "Батальон ЖИЗНЬ", dates: "20 апр – 19 мая 2026" },
  { name: "Батальон ОГОНЬ", dates: "20 мая – 18 июн 2026" },
  { name: "Батальон ЗЕМЛЯ", dates: "19 июн – 18 июл 2026" },
  { name: "Батальон КОСМОС", dates: "19 июл – 17 авг 2026" },
  { name: "Батальон ЭФИР", dates: "18 авг – 16 сен 2026" }
];
...
// Названия 30  — теперь только "Взвод N"
const dayMeanings = Array.from({ length: 30 }, (_, i) => `Взвод ${i + 1}`);
...
function onDayClick(monthIndex, dayNumber, cell) {
  ...
  detailsEl.innerHTML = `
    Выбран: <b>${month.name}</b>, Взвод <b>${dayNumber}</b> (Рота ${decada})<br>
...
function createIcsEvent(month, dayNumber, meaning, date) {
  ...
  const summary = `StarAdam: ${month.name}, Взвод ${dayNumber}`;
...
function renderApp() {
  ...
  if (starToday) {
    ...
    status.innerHTML = `
      Сегодня:
      <b>${m.name}</b>, Взвод <b>${starToday.dayNumber}</b>
